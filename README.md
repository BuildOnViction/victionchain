...
Install Go for your platform from here [https://go.dev/dl/](https://go.dev/dl/). Viction can now work with recent Go version.
...
```bash
docker build --file Dockerfile.node -t "buildonviction/node:v2.6.1" .
```
