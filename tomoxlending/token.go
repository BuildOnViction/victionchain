...
func (l *Lending) GetTokenDecimal(chain consensus.ChainContext, statedb *state.StateDB, coinbase common.Address, tokenAddr common.Address) (*big.Int, error) {
	if tokenDecimal, ok := l.tokenDecimalCache.Get(tokenAddr); ok {
		return tokenDecimal.(*big.Int), nil
	}
	if tokenAddr.String() == common.TomoNativeAddress {
		l.tokenDecimalCache.Add(tokenAddr, common.BasePrice)
	...
	l.tokenDecimalCache.Add(tokenAddr, tokenDecimal)
