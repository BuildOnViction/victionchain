...
type Validator interface {
	...
	ValidateMatchingOrder(statedb *state.StateDB, chancoinxStatedb *chancoinx_state.ChancoinXStateDB, txMatchBatch chancoinx_state.TxMatchBatch, coinbase common.Address) error
}
