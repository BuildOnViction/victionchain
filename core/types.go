...
type Validator interface {
	...
	ValidateMatchingOrder(statedb *state.StateDB, tomoxStatedb *trading_state.TradingStateDB, txMatchBatch trading_state.TxMatchBatch, coinbase common.Address) error
}
