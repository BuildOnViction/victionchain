...
var (
	...
	ErrPmPayloadTooShort           = errors.New("the length of the paymaster payload is under 20 bytes minumum")
)
...
func (pool *TxPool) add(tx *types.Transaction, local bool) (bool, error) {
	...
	opts := &ValidationOptions{
		...
		Accept: 0 |
			...
			1<<types.PaymasterTxType,
	}
	// If the transaction fails basic validation, discard it
	if err := pool.validateTx(tx, local, opts); err != nil {
