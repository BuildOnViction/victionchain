...
func MakeSigner(config *params.ChainConfig, blockNumber *big.Int) Signer {
	var signer Signer
	switch {
	case config.IsEIP2718(blockNumber):
...
// NewEIP2718Signer returns a signer that accepts
// - EIP-2718 paymaster transactions
// - EIP-155 replay protected transactions, and
// - legacy Homestead transactions.
func NewEIP2718Signer(chainId *big.Int) Signer {
...
func (s eip2718Signer) Sender(tx *Transaction) (common.Address, error) {
	...
	case PaymasterTxType:
		// PM txs are defined to use 0 and 1 as their recovery
