...
func (b *EthApiBackend) GetVotersRewards(masternodeAddr common.Address) map[common.Address]*big.Int {
	...
	chainReward := currentChainReward(b.ChainConfig(), block.Number())
	chainReward = rewardInflation(b.ChainConfig(), chainReward, lastCheckpointNumber, common.BlocksPerYear)
