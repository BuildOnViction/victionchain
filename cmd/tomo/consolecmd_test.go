...
func TestConsoleWelcome(t *testing.T) {
	...
	tomo.SetTemplateFunc("niltime", func() string { return time.Unix(0, 0).Format("Mon Jan 02 2006 15:04:05 GMT-0700 (MST)") })
...
func testAttachWelcome(t *testing.T, tomo *testtomo, endpoint, apis string) {
	...
	attach.SetTemplateFunc("niltime", func() string { return time.Unix(0, 0).Format("Mon Jan 02 2006 15:04:05 GMT-0700 (MST)") })
