...
func makeConfigNode(ctx *cli.Context) (*node.Node, chancoinConfig) {
	...
	cfg := chancoinConfig{
		...
		ChancoinX:       chancoinx.DefaultConfig,
	...
	utils.SetChancoinXConfig(ctx, &cfg.ChancoinX)
...
func makeFullNode(ctx *cli.Context) (*node.Node, chancoinConfig) {
	...
	// Register ChancoinX's OrderBook service if requested.
	// enable in default
	utils.RegisterChancoinXService(stack, &cfg.ChancoinX)
