...
import (
	...
	"github.com/chancoin-core/chancoin-gold/internal/build"
)
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/chancoin-core/chancoin-gold/mobile")
