...
func (ch insertOrder) undo(s *ChancoinXStateDB) {
	s.CancelOrder(ch.orderBook, ch.order)
}
func (ch cancelOrder) undo(s *ChancoinXStateDB) {
	s.InsertOrderItem(ch.orderBook, ch.orderId, ch.order)
}
func (ch subAmountOrder) undo(s *ChancoinXStateDB) {
...
func (ch nonceChange) undo(s *ChancoinXStateDB) {
	s.SetNonce(ch.hash, ch.prev)
}
func (ch priceChange) undo(s *ChancoinXStateDB) {
