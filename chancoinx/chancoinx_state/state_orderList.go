...
func newStateOrderList(db *ChancoinXStateDB, orderType string, orderBook common.Hash, price common.Hash, data orderList, onDirty func(price common.Hash)) *stateOrderList {
...
func (self *stateOrderList) deepCopy(db *ChancoinXStateDB, onDirty func(price common.Hash)) *stateOrderList {
