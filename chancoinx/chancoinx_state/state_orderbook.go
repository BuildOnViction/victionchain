...
func newStateExchanges(db *ChancoinXStateDB, hash common.Hash, data exchangeObject, onDirty func(addr common.Hash)) *stateExchanges {
...
func (self *stateExchanges) deepCopy(db *ChancoinXStateDB, onDirty func(hash common.Hash)) *stateExchanges {
